...
public class TFM_Admin
{
    ...
    public TFM_Admin(UUID uuid, String lastLoginName, Date lastLogin, String loginMessage, boolean isSeniorAdmin, boolean isSuperAdmin, boolean isActivated)
    {
        this.uuid = uuid;
    ...
    public TFM_Admin(UUID uuid, ConfigurationSection section)
    {
        ...
        this.isSuperAdmin = section.getBoolean("is_super_admin", false);
    ...
    public String toString()
    {
        ...
        output.append("- Is Super Admin: ").append(isSuperAdmin).append("\n");
